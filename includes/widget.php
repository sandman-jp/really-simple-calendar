			...
			<div class="rsc-widget">
				...
				<div class="components-placeholder__fieldset rsc-widget-input">
					<select id="rsc-calendar-start_of_week" name="<?php echo $this->get_field_name(RS_CALENDAR.'_start_of_week'); ?>" class="rsc-widget-item" <?php disabled($is_locked_start_of_week); ?>>
						...
						<option value="today" <?php selected($instance[RS_CALENDAR.'_start_of_week'], 'today'); ?>><?php esc_html_e('Today', 'really-simple-calendar'); ?></option>
						<option value="0" <?php selected($instance[RS_CALENDAR.'_start_of_week'], '0'); ?>><?php esc_html_e('Sunday', 'really-simple-calendar'); ?></option>
						<option value="1" <?php selected($instance[RS_CALENDAR.'_start_of_week'], '1'); ?>><?php esc_html_e('Monday', 'really-simple-calendar'); ?></option>
						<option value="2" <?php selected($instance[RS_CALENDAR.'_start_of_week'], '2'); ?>><?php esc_html_e('Tuesday', 'really-simple-calendar'); ?></option>
						<option value="3" <?php selected($instance[RS_CALENDAR.'_start_of_week'], '3'); ?>><?php esc_html_e('Wednesday', 'really-simple-calendar'); ?></option>
						<option value="4" <?php selected($instance[RS_CALENDAR.'_start_of_week'], '4'); ?>><?php esc_html_e('Thursday', 'really-simple-calendar'); ?></option>
						<option value="5" <?php selected($instance[RS_CALENDAR.'_start_of_week'], '5'); ?>><?php esc_html_e('Friday', 'really-simple-calendar'); ?></option>
						<option value="6" <?php selected($instance[RS_CALENDAR.'_start_of_week'], '6'); ?>><?php esc_html_e('Saturday', 'really-simple-calendar'); ?></option>
						<?php endif; ?>
					</select>
				</div>
