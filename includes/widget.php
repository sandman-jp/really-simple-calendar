			...
			<div class="rsc-widget">
				...
				<div class="components-placeholder__fieldset rsc-widget-input">
					<select id="rsc-calendar-type" name="<?php echo $this->get_field_name(RS_CALENDAR.'_type'); ?>" class="rsc-widget-item" <?php disabled($is_locked_type); ?> style="background-image:" >
						...
						<option value="month" <?php selected($instance[RS_CALENDAR.'_type'], 'month'); ?>><?php _e('Monthly', RSC_TEXTDOMAIN); ?></option>
						<option value="week" <?php selected($instance[RS_CALENDAR.'_type'], 'week'); ?>><?php _e('Weekly', RSC_TEXTDOMAIN); ?></option>
						<option value="day" <?php selected($instance[RS_CALENDAR.'_type'], 'day'); ?>><?php _e('Daily', RSC_TEXTDOMAIN); ?></option>
						<?php endif; ?>
					</select>
				...
				<?php if(!$is_locked_type): ?>
					<select id="rsc-calendar-type-align" name="<?php echo $this->get_field_name(RS_CALENDAR.'_align'); ?>" class="rsc-widget-item" required>
						<option value=""><?php _e('Default', RSC_TEXTDOMAIN); ?></option>
						<option value="0" <?php selected($instance[RS_CALENDAR.'_align'], '0'); ?>><?php _e('Horizontal', RSC_TEXTDOMAIN); ?></option>
						<option value="1" <?php selected($instance[RS_CALENDAR.'_align'], '1'); ?>><?php _e('Vertical', RSC_TEXTDOMAIN); ?></option>
					</select>
				...
				<div class="components-placeholder__fieldset rsc-widget-input">
					<select id="rsc-calendar-from" name="<?php echo $this->get_field_name(RS_CALENDAR.'_from'); ?>" class="rsc-widget-item" <?php disabled($is_locked_from); ?>>
						...
						<option value="previous" <?php selected($instance[RS_CALENDAR.'_from'], 'previous'); ?>><?php _e('Previous', RSC_TEXTDOMAIN); ?></option>
						<option value="current" <?php selected($instance[RS_CALENDAR.'_from'], 'current'); ?>><?php _e('Current', RSC_TEXTDOMAIN); ?></option>
						<option value="next" <?php selected($instance[RS_CALENDAR.'_from'], 'next'); ?>><?php _e('Next', RSC_TEXTDOMAIN); ?></option>
						<option value="today" <?php selected($instance[RS_CALENDAR.'_from'], 'today'); ?>><?php _e('Today', RSC_TEXTDOMAIN); ?></option>
						<option value="date" <?php selected($instance[RS_CALENDAR.'_from'], 'date'); ?>><?php _e('Date', RSC_TEXTDOMAIN); ?></option>
						<?php endif; ?>
					</select>
				...
				<div class="components-placeholder__fieldset rsc-widget-input">
					<select id="rsc-calendar-period" name="<?php echo $this->get_field_name(RS_CALENDAR.'_period'); ?>" class="rsc-widget-item" <?php disabled($is_locked_period); ?>>
						...
						<option value="last" <?php selected($instance[RS_CALENDAR.'_period'], 'last'); ?>><?php _e('Priod', RSC_TEXTDOMAIN); ?></option>
						<option value="date" <?php selected($instance[RS_CALENDAR.'_period'], 'date'); ?>><?php _e('Date', RSC_TEXTDOMAIN); ?></option>
						<?php endif; ?>
					</select>
